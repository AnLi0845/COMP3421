...
if ($type == "self") { ?>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12">
      ...
      Pick-Up Time: <input type="time" id="pickupTime" name="pickupTime" required><br>
      Our Branch Opening Hour: 24 hours<br>
    </div>
...
//delivery, choose delivery date, time
    ...
    <div class="col-lg-6 col-md-6 col-sm-12">
      <h2>Delivery</h2>
      Delivery Date: <input type="date" id="deliveryDate" name="deliveryDate" min="<?= date('Y-m-d', strtotime('+1 days')); ?>" max="<?= date('Y-m-d', strtotime('+30 days')); ?>" required><br>
      Delivery Time: <input type="time" id="deliveryTime" name="deliveryTime" required><br>
