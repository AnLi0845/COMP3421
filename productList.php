...
<h2 align='center'>Welcome to select and purchase our products！</h2>
<body class="body">
...
<?php
 ...
 <div class="card mx-auto" style="width: 19rem;">
    ...
    <div class="card-body ">
        ...
        <h6 class="card-text"><?=$p_cashpoint?> cashpoint</h6>
        Quantity: <input id='quantity' type='number' name='quantity' value='1' min='1' max='10' style="margin-bottom: 10px;"><br><br>
