    ...
    $userID = $_SESSION["id"];
        ...
        if($numOfRecord == 0) {
            ...
            <div class="alert alert-danger">
                <a href="login.php" class="alert-link">Please add products in the cart!</a>
            </div>
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<td ><input id='number' type='number' name='quantity' value='$cart_quantity' min='1' max='10'></td>";
            echo "<td >"."$total"."</td>";
        ...
        <tr>
            ...
            <td><h5><?=$numOfRecord?> items,<br> Total <?=$totalPrice?> cashpoint</h5></td>

            <input type='hidden' name='action' value='payment'>
            <input type='hidden' name='totalPrice' value='<?=$totalPrice?>'>
            <td><input type="submit" value="Payment" class="btn btn-success" id="submit"></td>
            </form>
